...
public class Generate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String key : templates.keySet()) {
            ...
            generateStubs(root.getAsJsonObject("parent"), processedClasses);

            generateBasicStubs(root.getAsJsonObject("mappings").get("classes").getAsJsonArray(), processedClasses);

            // generate classes for all mc versions
            writeAndRemapTemplate(key, root.getAsJsonObject("parent").get("class").getAsString(),
    ...
    private static void generateStubs(JsonObject parent, Set<String> processedClasses) throws Exception {
    ...
    private static void generateBasicStubs(JsonArray classes, Set<String> processedClasses) throws Exception {
    ...
    private static void writeAndRemapTemplate(
        String template, String versionClass, JsonObject mappings) throws IOException
    {
        ...
        for (String version : getVersions(versionClass)) {
            ...
            try (FileWriter writer = new FileWriter(target)) {
                ...
                for (JsonElement clazz : mappings.getAsJsonArray("classes")) {
                    code = code.replace(clazz.getAsString(), getClass(clazz.getAsString(), version));
                }
