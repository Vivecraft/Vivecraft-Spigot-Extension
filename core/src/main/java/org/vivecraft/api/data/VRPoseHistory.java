...
public interface VRPoseHistory {
     ...
     */
    @Nullable
    default Vector netMovement(VRBodyPart bodyPart, int maxTicksBack) throws IllegalArgumentException {
     ...
     */
    @Nullable
    default Vector averageVelocity(VRBodyPart bodyPart, int maxTicksBack) throws IllegalArgumentException {
     ...
     */
    @Nullable
    default Vector averagePosition(VRBodyPart bodyPart, int maxTicksBack) throws IllegalArgumentException {
